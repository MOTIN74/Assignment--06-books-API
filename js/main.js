...
const searchBooks = () => {
    ...
    if (input.value === '') {
        ...
        <h2 class="my-4 text-center" style="font-family: 'Poppins', sans-serif;">You've to type any Books name first</h2>
    </div>`;
...
const displayResult = allData => {
    ...
    if (allData.length === 0 ) {
        ...
        <h2 class="my-4 text-center" style="font-family: 'Poppins', sans-serif;">No Books Found</h2>
        </div>`;
        ...
        allData?.forEach(data => {
            ...
            <div style="height: 500px;" class="card p-2 m-3 rounded ">
                ...
                <h3 style="font-family: 'Poppins', sans-serif;">${data.title}</h3>
                <p class="p-0 m-0" style="font-family: 'Poppins', sans-serif;"><span class="fw-bold">Author:</span> ${data.author_name}</p>
                <p class="p-0 m-0" style="font-family: 'Poppins', sans-serif;"><span class="fw-bold">Publisher:</span> ${data.publisher}</p>
                <p class="p-0 m-0" style="font-family: 'Poppins', sans-serif;"><span class="fw-bold">First publish :</span> ${data.first_publish_year}</p>
            </div>
            `
